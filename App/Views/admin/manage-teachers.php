    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="container rounded bg-white mt-5 mb-5">
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="card" style="width: 18rem;" onclick="window.location = '<?php echo CONFIG['base_url']; ?>/admin/manage-teachers/register';">
              ...
              <div class="card-body">
                ...
                <p class="card-text">Register New Teacher</p>
              </div>
            </div>
          </div>
        </div>
