  ...
  <div class="row" id="allContainer">
    ...
    <div class="row">
        ...
        <div class="col-md-10">
            <div class="container">
                <div class="row">
                    <div class="col-md-3"><button onclick="<?php if ($_SERVER['REQUEST_METHOD'] == 'POST') echo 'window.location = \'' . CONFIG['base_url']. '/admin/manage-students/manage\''; else echo 'window.history.back()';?>" class="btn btn-outline-primary">Go Back</button></div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="" style="width: 100%; border: 1px solid #007bff;height: 200px; padding:5px; overflow:hidden; border-radius:3px;" onclick="document.getElementById('studentPictureSelect').click()">
                                    <img src="<?= $studentData['student_photo'] ?>" alt="Select Pic"  class="img-thumbnail" id="studentImage">
                                </div>
...
window.addEventListener('DOMContentLoaded', function() {
    ...
    var optSelections = [
        '#admissionClassSelect option[value=\'<?= $studentData['student_class']['ID'] ?>\']',
        ...
        '#studentShiftSelect option[value=\'<?= $studentData['student_shift']['ID'] ?>\']',
        '#studentGroupSelect option[value=\'<?= $studentData['student_group']['ID'] ?>\']',
        '#studentSectionSelect option[value=\'<?= @$studentData['student_section']['ID'] ?>\']',
