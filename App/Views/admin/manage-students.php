          ...
          <div class="col-md-4">
            <div class="card" style="width: 18rem;" onclick="window.location = '<?php echo CONFIG['base_url']; ?>/admin/manage-students/approval';">
              ...
              <div class="card-body">
                ...
                <p class="card-text">Approve Registered Students</p>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="card" style="width: 18rem;" onclick="window.location = '<?php echo CONFIG['base_url']; ?>/admin/manage-students/manage';">
              ...
              <div class="card-body">
                ...
                <p class="card-text">Manage Registerd Students</p>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="card" style="width: 18rem;" onclick="window.location = '<?php echo CONFIG['base_url']; ?>/admin/manage-students/register';">
              ...
              <div class="card-body">
                ...
                <p class="card-text">Register New Students</p>
              </div>
            </div>
          </div>
        </div>
