      ...
      <div class="container rounded bg-white mt-5 mb-5">
        ...
        <div class="col-md-3 border-right">
            <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                <img class="img-thumbnail mt-5" width="150" src="<?= getStudentImageUrl($studentData['student_photo']) ?>">
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="p-3 py-5">
            <div class="col-md-12"><label class="labels">Class</label><input type="text" class="form-control" placeholder="Class" value="<?= $studentData['class_name'] ?>" disabled></div>
                    <div class="col-md-12"><label class="labels">Group</label><input type="text" class="form-control" placeholder="Group" value="<?= $studentData['group_title'] ?>" disabled></div>
                    <div class="col-md-12"><label class="labels">Section</label><input type="text" class="form-control" placeholder="Section" value="<?= @$studentData['section_title'] ?>" disabled></div>
                    ...
                    <div class="col-md-12"><label class="labels">Shift</label><input type="text" class="form-control" placeholder="" value="<?= $studentData['shift_title'] ?>" disabled></div>
                    <div class="col-md-12"><label class="labels">Optional Subject</label><input type="text" class="form-control" placeholder="" value="" disabled></div>
            </div>
        </div>
        </div>
      </div>
