...
class ReportControler extends AdminControler {
    ...
    public function idCardView() {
        ...
        $this->load->view('admin/report/id_card', array(
    ...
    public function examResultView() {
        ...
        $this->load->view('inc/basic-header');
        $this->load->view('admin/inc/admin-nav');
        $this->load->view('admin/report/result_sheet', array(
            'siteOptions' => $this->siteOptions,
            'exams' => $exams,
    ...
    public function examResultGenarate() {
    ...
    public function resultCardView() {

        $this->load->view('admin/report/result_card', array(
            'siteOptions' => $this->siteOptions
        ));
